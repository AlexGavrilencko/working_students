                            ...
                            <div class="row justify-content-center">
                                <?php   
                                    $user = Yii::$app->user->identity;
                                        if($model->image): ?>
                                            <img class=" logo_user img-fluid img-thumbnail"  src="/uploads/<?= $model->image?>" alt="">
                                        <?php endif; 
                                ?>
                            </div>
                        <br>
                                ...
                                <p class="row justify-content-center">
                                    <?= Html::a('Добавить опыт работы', ['experience_cr','res_id'=>$model->id,'or'=>'1'], ['class' => 'btn btn-sm btn-rounded btngreen ml-1']) ?>
                                    <?= Html::a('Добавить образование', ['experience_cr','res_id'=>$model->id,'or'=>'0'], ['class' => 'btn btn-sm btn-rounded btngreen ml-1']) ?>
                                </p>
