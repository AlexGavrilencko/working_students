...
<div class="header2 h-100" style="height: 480px;">
        ...
        <nav class="navbar navbar-expand-lg light"> <!-- стиль для меню сайта -->
             ...
             <a href="/site/indexwork" class="navbar-brad"><img src="/public/img/logo.jpg" alt="Logo"></a>  <!-- логотип в меню сайта -->
        ...
        <div class="container-fluid d-flex h-100 d-flex flex-row bd-highlight flex-column">        
            <div class="row">
                ...
                <div class="col">
                    <a href="/site/registration" class="btn-rounded btngreen btn btn-lg m-4">Разместить вакансию</a>
                </div>
            </div>
